...
{
    public class AdminCategoryByIdSpecificationTests
    {
        ...
        [Fact]
        public void Id_NotFound_ReturnsEmpty()
        {
            // Arrange
            var spec = new AdminCategoryByIdSpecification(nonExistentGuid);
        ...
        {
            // Arrange
            var spec = new AdminCategoryByIdSpecification(guid1);
